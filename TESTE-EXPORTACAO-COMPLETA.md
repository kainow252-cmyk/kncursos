# 📊 Teste de Exportação Completa - Vemgo
...
```bash
curl "https://vemgo.com.br/api/admin/sales/export/csv"
```
...
- [x] Download automático com nome `vendas_completas_vemgo_YYYY-MM-DD.csv`
